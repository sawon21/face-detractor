...
const students = [
    { id: "20240241", name: "John Doe", roll: "101", department: "Science" },
    { id: "20240242", name: "Jane Smith", roll: "102", department: "Arts" },
    { id: "20240243", name: "Alice Johnson", roll: "103", department: "Commerce" }
];
...
domReady(function () {
    ...
    // Check if a student has already been marked present.
    ...
    function showModal(message, type) {
        ...
        // Set modal style based on the type (success, warning, danger).
        ...
        setTimeout(() => $('#resultModal').modal('hide'), 2000);
    }
